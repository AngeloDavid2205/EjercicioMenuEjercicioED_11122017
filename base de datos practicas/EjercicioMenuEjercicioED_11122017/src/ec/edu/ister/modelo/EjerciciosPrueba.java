...
public class EjerciciosPrueba {
    ...
    public void menu(){
        char op;
        do{
            op=JOptionPane.showInputDialog("a.- Llenar  randomicamente\n"
               + "b.- Imprimir arreglo String\n"
               + "c.- Imprimir arreglo  JOptionPane y  toString\n"
               + "d.- Ordenar arreglo ascendentemente\n"
